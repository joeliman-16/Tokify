      ...
      >
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          >
            ...
            <h1 className="text-2xl font-bold font-heading text-gray-900 mb-2">Tokify</h1>
            <p className="text-sm text-gray-600 font-body">Scan. Pay. Trust.</p>
          </motion.div>
            ...
            >
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-900 focus:border-transparent font-body"
          ...
          <motion.button
            ...
            className="w-full bg-white border border-gray-300 text-gray-700 py-3 rounded-lg font-semibold font-body hover:bg-gray-50 transition-all duration-200 flex items-center justify-center gap-3"
          >
          ...
          <motion.p
            ...
            className="text-center text-sm text-gray-600 mt-6 font-body"
          >
            Don't have an account?{' '}
            <Link
              href="/auth/register"
              className="text-orange-600 hover:text-orange-700 font-semibold font-body"
            >
              Sign up
            </Link>
          </motion.p>
