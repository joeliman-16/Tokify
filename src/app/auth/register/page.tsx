...
export default function RegisterPage() {
  ...
  const handleGoogleSignUp = () => {
    signIn('google', { callbackUrl: '/dashboard/setup' })
  }
      ...
      >
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          >
            ...
            <h1 className="text-2xl font-bold font-heading text-gray-900 mb-2">Create Account</h1>
            <p className="text-sm text-gray-600 font-body">Join Tokify and grow your business</p>
          </motion.div>
